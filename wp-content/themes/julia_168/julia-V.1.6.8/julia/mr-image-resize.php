...
add_action('delete_attachment', 'julia_kaya_delete_resized_images');
if( !function_exists('julia_kaya_image_resize') ){
function julia_kaya_image_resize($url, $width=null, $height=null, $crop=true, $align='c', $retina=false) {

  global $wpdb;
  // Get common vars (func_get_args() only get specified values)
  $common = julia_kaya_common_info($url, $width, $height, $crop, $align, $retina);  
...
if(  !function_exists('julia_kaya_common_info') ){
function julia_kaya_common_info($url, $width, $height, $crop, $align, $retina) {
...
if( !function_exists('julia_kaya_delete_resized_images') ){
function julia_kaya_delete_resized_images($post_id) {
