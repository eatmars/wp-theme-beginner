<?php get_header();
	$error_page_button_name = get_theme_mod('error_page_button_name') ?  get_theme_mod('error_page_button_name') : esc_html__('GO TO HOME PAGE', 'julia');
	...
	<div id="mid_container_wrapper" class="mid_container_wrapper_section">
		<div id="mid_container" class="">
	        <!-- End Page Titles -->
	        <?php $error_page_description = get_theme_mod('error_page_description') ? get_theme_mod('error_page_description') : esc_html__('the link you clicked might be currupted, or the page may have removed', 'julia');
	        $error_page_title = get_theme_mod('error_page_title') ? get_theme_mod('error_page_title') : esc_html__('Sorry, this page does not exist', 'julia');  ?>
