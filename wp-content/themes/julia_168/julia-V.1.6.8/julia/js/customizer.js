...
wp.customize('menu_link_color', function( value ){
	value.bind(function(to){
		var menu_link_color = '.menu > ul > li > a, .shop_cart_icon a, .search_box_icon, .mobile_toggle_menu i, .mobile_drop_down_icons i, .mobile_menu_section ul a, .mobile_menu_section ul ul li a, .kta-user-accocunt > a{color:'+ to +'!important}';
...
wp.customize('sub_menu_top_border_color', function(value){
	value.bind(function( to ){
		var sub_menu_top_border_color = '.menu ul ul.sub-menu li{ border-top-color:'+ to +'!important; }';
...
wp.customize('sub_menu_bottom_border_color', function(value){
	value.bind(function( to ){
		var sub_menu_bottom_border_color = '.menu ul ul.sub-menu li{ border-bottom-color:'+ to +'!important; }';
...
//icon hover color
wp.customize('search_icon_bg_hover_color', function( value ){
	value.bind(function( to ){
	var search_icon_bg_hover_color = '.toggle_search_icon:hover{ background :'+ to +'!important}';
		if($(document).find('#search_icon_bg_hover_color').length) {
			$(document).find('#search_icon_bg_hover_color').remove();
		}
	$(document).find('head').append($('<style id="search_icon_bg_hover_color">' + search_icon_bg_hover_color + '</style>'));
	});
});
wp.customize('search_icon_hover_color', function( value ){
	value.bind(function( to ){
	var search_icon_hover_color = '.toggle_search_icon:hover{ color :'+ to +'!important}';
		if($(document).find('#search_icon_hover_color').length) {
			$(document).find('#search_icon_hover_color').remove();
		}
	$(document).find('head').append($('<style id="search_icon_hover_color">' + search_icon_hover_color + '</style>'));
	});
});

wp.customize('search_box_bg_color', function( value ){
	value.bind(function( to ){
	var search_box_bg_color = '.toggle_search_wrapper .toggle_search_field, .toggle_search_wrapper{ background :'+ to +'!important}';
...
//
wp.customize('sidebar_tags_hover_bg_color', function( value ){
	value.bind(function( to ){
		var sidebar_tags_hover_bg_color = '.widget_container .tagcloud a:hover{background-color:'+ to +'!important;}';
		if($(document).find('#sidebar_tags_hover_bg_color').length) {
			$(document).find('#sidebar_tags_hover_bg_color').remove();
		}
		$(document).find('head').append($('<style id="sidebar_tags_hover_bg_color">' + sidebar_tags_hover_bg_color + '</style>'));
	});
});
wp.customize('sidebar_tags_hover_text_color', function( value ){
	value.bind(function( to ){
		var sidebar_tags_hover_text_color = '.widget_container .tagcloud a:hover{color:'+ to +'!important;}';
		if($(document).find('#sidebar_tags_hover_text_color').length) {
			$(document).find('#sidebar_tags_hover_text_color').remove();
		}
		$(document).find('head').append($('<style id="sidebar_tags_hover_text_color">' + sidebar_tags_hover_text_color + '</style>'));
	});
});
//page title colors
...
wp.customize('pf_cat_img_side_title_color', function( value ){
	value.bind(function( to ){
		var pf_cat_img_side_title_color = '.pf_taxonomy_gallery.portfolio_content_wrapper span.pf_title_wrapper, .kta-talent-content-wrapper ul.grid li h4{color:'+ to +'!important}';
...
wp.customize('pf_cat_img_border_color', function( value ){
	value.bind(function( to ){
		var pf_cat_img_border_color = '.pf_taxonomy_gallery.portfolio_img_grid_columns > ul li .pf_image_wrapper, .kta-talent-content-wrapper ul.grid li h4{border-color:'+ to +'!important} .pf_taxonomy_gallery.portfolio_content_wrapper span.pf_title_wrapper, .kta-talent-content-wrapper ul.grid li h4{background:'+ to +'!important}';
...
wp.customize('vertical_title_font_size', function( value ){
	value.bind(function( to ){
		var vertical_title_font_size = '.pf_taxonomy_gallery.portfolio_content_wrapper span.pf_title_wrapper, .kta-talent-content-wrapper ul.grid li h4{font-size:'+ to +'px!important}';
...
wp.customize('vertical_title_font_style', function( value ){
	value.bind(function( to ){
		var vertical_title_font_style = '.pf_taxonomy_gallery.portfolio_content_wrapper span.pf_title_wrapper, .kta-talent-content-wrapper ul.grid li h4{font-style:'+ to +'!important}';
...
wp.customize('vertical_title_font_weight', function( value ){
	value.bind(function( to ){
		var vertical_title_font_weight = '.pf_taxonomy_gallery.portfolio_content_wrapper span.pf_title_wrapper, .kta-talent-content-wrapper ul.grid li h4{font-weight:'+ to +'!important}';
...
wp.customize('vertical_title_letter_space', function( value ){
	value.bind(function( to ){
		var vertical_title_letter_space = '.pf_taxonomy_gallery.portfolio_content_wrapper span.pf_title_wrapper, .kta-talent-content-wrapper ul.grid li h4{letter-spacing:'+ to +'px!important}';
...
wp.customize('pf_cat_hover_bg_color', function( value ){
	value.bind(function( to ){
		var pf_cat_hover_bg_color = '.pf_taxonomy_gallery .pf_content_wrapper, .kta-image-details-wrapper .mata_data_info_wrapper{background:'+ to +'!important}';
...
wp.customize('pf_cat_title_color', function( value ){
	value.bind(function( to ){
		var pf_cat_title_color = '.pf_taxonomy_gallery .pf_title_description h3, .kta-image-details-wrapper .mata_data_info_wrapper{color:'+ to +'!important}';
...
wp.customize('pf_cat_desc_color', function( value ){
	value.bind(function( to ){
		var pf_cat_desc_color = '.pf_taxonomy_gallery .pf_title_description, .kta-image-details-wrapper .mata_data_info_wrapper span{color:'+ to +'!important}';
...
wp.customize('pf_contant_bg_color', function( value ){
	value.bind(function( to ){
		var pf_contant_bg_color = ' #mid_container_wrapper .kta_left_section_wrapper{background:'+ to +'!important}';
...
wp.customize('pf_slider_button_arrow_bg_color', function( value ){
	value.bind(function( to ){
		var pf_slider_button_arrow_bg_color = ' #gallery_horizontal .owl-next, #gallery_horizontal .owl-prev{background:'+ to +'!important}';
		if($(document).find('#pf_slider_button_arrow_bg_color').length) {
			$(document).find('#pf_slider_button_arrow_bg_color').remove();
		}
	$(document).find('head').append($('<style id="pf_slider_button_arrow_bg_color">' + pf_slider_button_arrow_bg_color + '</style>'));

	});
});
wp.customize('pf_slider_button_arrow_color', function( value ){
	value.bind(function( to ){
		var pf_slider_button_arrow_color = '#gallery_horizontal .owl-next, #gallery_horizontal .owl-prev{color:'+ to +'!important}';
		if($(document).find('#pf_slider_button_arrow_color').length) {
			$(document).find('#pf_slider_button_arrow_color').remove();
		}
	$(document).find('head').append($('<style id="pf_slider_button_arrow_color">' + pf_slider_button_arrow_color + '</style>'));
...
wp.customize('pf_model_details_title_color', function( value ){
	value.bind(function( to ){
		var pf_model_details_title_color = '#mid_container_wrapper .mata_data_info_wrapper ul li strong{color:'+ to +'!important}';
...
wp.customize('pf_porject_details_info_color', function( value ){
	value.bind(function( to ){
		var pf_porject_details_info_color = '#mid_container_wrapper .mata_data_info_wrapper ul li span{color:'+ to +'!important}';
...
wp.customize('pf_tabs_bg_color', function( value ){
	value.bind(function( to ){
		var pf_tabs_bg_color = '.pf_tab_list > ul > li.pf_tabs_style, .pf_tab_list > ul > li.pf_tabs_style:first-child::before, .pf_tab_list > ul > li.pf_tabs_style:last-child::before, .pf_tab_list > ul > li.pf_tabs_style, .pf_tab_list > ul > li.pf_tabs_style:first-child::before, .pf_tab_list > ul > li.pf_tabs_style:last-child::before, .model_share_icon, #kta-form-tabs li{background:'+ to +'!important}.model_share_icon::before{ border-bottom-color: '+ to +' }';
...
wp.customize('pf_tabs_text_color', function( value ){
	value.bind(function( to ){
		var pf_tabs_text_color = '#mid_container_wrapper .pf_tab_list > ul > li.pf_tabs_style > a, #mid_container_wrapper .pf_tab_list > ul > li.pf_tabs_style:first-child::before, #mid_container_wrapper .pf_tab_list > ul > li.pf_tabs_style:last-child::before, .model_share_icon, #kta-form-tabs > li a {color:'+ to +'!important}';
...
wp.customize('contnet_warning_bg_color', function( value ){
	value.bind(function( to ){
		var contnet_warning_bg_color = '.content_alert_dialog_box{background:'+ to +'!important}';
		if($(document).find('#contnet_warning_bg_color').length) {
			$(document).find('#contnet_warning_bg_color').remove();
		}
	$(document).find('head').append($('<style id="contnet_warning_bg_color">' + contnet_warning_bg_color + '</style>'));

	});
});
wp.customize('contnet_warning_color', function( value ){
	value.bind(function( to ){
		var contnet_warning_color = '.content_alert_dialog_box p, .content_alert_dialog_box, .content_alert_dialog_box li{color:'+ to +'!important}';
		if($(document).find('#contnet_warning_color').length) {
			$(document).find('#contnet_warning_color').remove();
		}
	$(document).find('head').append($('<style id="contnet_warning_color">' + contnet_warning_color + '</style>'));

	});
});
//button
wp.customize('contnet_warning_btn_bg_color', function( value ){
	value.bind(function( to ){
		var contnet_warning_btn_bg_color = '.content_alert_dialog_box .content_alert_dialog_btns a, .content_alert_dialog_btns a{background:'+ to +'!important}';
		if($(document).find('#contnet_warning_btn_bg_color').length) {
			$(document).find('#contnet_warning_btn_bg_color').remove();
		}
	$(document).find('head').append($('<style id="contnet_warning_btn_bg_color">' + contnet_warning_btn_bg_color + '</style>'));

	});
});
wp.customize('contnet_warning_btn_color', function( value ){
	value.bind(function( to ){
		var contnet_warning_btn_color = '.content_alert_dialog_box .content_alert_dialog_btns a, .content_alert_dialog_btns a{color:'+ to +'!important}';
		if($(document).find('#contnet_warning_btn_color').length) {
			$(document).find('#contnet_warning_btn_color').remove();
		}
	$(document).find('head').append($('<style id="contnet_warning_btn_color">' + contnet_warning_btn_color + '</style>'));
...
wp.customize('next_prev_button_letter_sapcing', function( value ){
		value.bind(function( to ){
		var next_prev_button_letter_sapcing ='#singlepage_nav .nav_prev_item a, #singlepage_nav .nav_next_item a{ letter-spacing: '+ to +'px!important; }';
...
wp.customize('next_prev_button_font_weight', function( value ){
	value.bind(function( to ){
		var next_prev_button_font_weight ='#singlepage_nav .nav_prev_item a, #singlepage_nav .nav_next_item a{ font-weight: '+ to +' !important; }'
...
wp.customize('next_prev_button_font_style', function( value ){
	value.bind(function( to ){
		var next_prev_button_font_style ='#singlepage_nav .nav_prev_item a, #singlepage_nav .nav_next_item a{ font-style: '+ to +' !important; }'
...
// Comp card Settings
wp.customize('pf_compcard_title_bg_color', function( value ){
	value.bind(function( to ){
		var pf_compcard_title_bg_color = '#setcard h3{background:'+ ( to ? to : 'inherit') +'!important; }';
		if($(document).find('#pf_compcard_title_bg_color').length) {
			$(document).find('#pf_compcard_title_bg_color').remove();
		}
	$(document).find('head').append($('<style id="pf_compcard_title_bg_color">' + pf_compcard_title_bg_color + '</style>'));
	});
});


wp.customize('pf_compcard_title_color', function( value ){
	value.bind(function( to ){
		var pf_compcard_title_color = '#setcard h3{color:'+ ( to ? to : 'inherit') +'!important; }';
		if($(document).find('#pf_compcard_title_color').length) {
			$(document).find('#pf_compcard_title_color').remove();
		}
	$(document).find('head').append($('<style id="pf_compcard_title_color">' + pf_compcard_title_color + '</style>'));

	});
});

wp.customize('pf_compcard_model_info_titles_color', function( value ){
	value.bind(function( to ){
		var pf_compcard_model_info_titles_color = '.portfolio_main_content_wrapper #setcard strong{color:'+ to +'!important; }';
		if($(document).find('#pf_compcard_model_info_titles_color').length) {
			$(document).find('#pf_compcard_model_info_titles_color').remove();
		}
	$(document).find('head').append($('<style id="pf_compcard_model_info_titles_color">' + pf_compcard_model_info_titles_color + '</style>'));

	});
});
wp.customize('pf_compcard_model_info_color', function( value ){
	value.bind(function( to ){
		var pf_compcard_model_info_color = '#setcard .mata_data_info_wrapper span{color:'+ to +'!important; }';
		if($(document).find('#pf_compcard_model_info_color').length) {
			$(document).find('#pf_compcard_model_info_color').remove();
		}
	$(document).find('head').append($('<style id="pf_compcard_model_info_color">' + pf_compcard_model_info_color + '</style>'));
...
wp.customize('coming_soon_date_color', function( value ){
	value.bind(function( to ){
	var coming_soon_date_color = '.coming_soon_date_color, .countdown_time{ color :'+ to +'!important}';
...
wp.customize('coming_soon_date_m_s_h_color', function( value ){
	value.bind(function( to ){
	var coming_soon_date_m_s_h_color = '.countdown_wrapper{ color :'+ to +'!important}';
		if($(document).find('#coming_soon_date_m_s_h_color').length) {
			$(document).find('#coming_soon_date_m_s_h_color').remove();
		}
	$(document).find('head').append($('<style id="coming_soon_date_m_s_h_color">' + coming_soon_date_m_s_h_color + '</style>'));
	});
});
...
wp.customize('footer_border_top_color', function( value ){
	value.bind(function( to ){
	var footer_border_top_color = '.bottom_footer_bar_wrapper{ border-top:1px solid '+ to +'!important}';
...
wp.customize('short_list_input_fields_colors', function( value ){
	value.bind(function( to ){
	var short_list_input_fields_colors = '.form_shortlist_data input, .form_shortlist_data textarea, span.shortlist_form_close{color: '+ to +'!important}';
...
wp.customize('booking_form_input_color', function( value ){
	value.bind(function( to ){
	var booking_form_input_color = '.form_shortlist_book_form input, .form_shortlist_book_form textarea, span.shortlist_book_form_close{color: '+ to +'!important}';
