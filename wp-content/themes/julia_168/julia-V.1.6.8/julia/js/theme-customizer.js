...
// Blog
$('#customize-control-blog_sidebar_positions input').change(function(){
	$('#customize-control-blog_sidebar_id').show().removeClass('customize-control-options-remove');
	var blog_sidebar_positions = $('#customize-control-blog_sidebar_positions input:checked' ).val();
	if( blog_sidebar_positions == 'fullwidth'	 ){
		$('#customize-control-blog_sidebar_id').hide().addClass('customize-control-options-remove');			
	}
}).change();
//end
function search_box_bg_settings(){
$('#customize-control-serarch_search_bg_type select').change(function(){
	...
	var search_box_bg = $('#customize-control-serarch_search_bg_type select option:selected').val();
	switch( search_box_bg ){
		case 'bg_type_color':
...
search_box_bg_settings();
// Search Box_Settings
// Disable Search Box
$('#customize-control-disable_search_box input').change(function(){
	$('#customize-control-change_search_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-disable_category_section').show().removeClass('customize-control-options-remove');
	$('#customize-control-change_category_name_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-disable_model_id').show().removeClass('customize-control-options-remove');
	$('#customize-control-disable_pf_sorting_options').show().removeClass('customize-control-options-remove');
	...
	$('#customize-control-search_icon_bg_hover_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-search_icon_hover_color').show().removeClass('customize-control-options-remove');
	search_box_bg_settings();
	var search_box_show = $('#customize-control-disable_search_box input').is(':checked');
	if( search_box_show == true ){
		$('#customize-control-change_search_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-disable_category_section').hide().addClass('customize-control-options-remove');
		$('#customize-control-change_category_name_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-disable_model_id').hide().addClass('customize-control-options-remove');
		$('#customize-control-disable_pf_sorting_options').hide().addClass('customize-control-options-remove');
		...
		$('#customize-control-search_icon_bg_hover_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-search_icon_hover_color').hide().addClass('customize-control-options-remove');
...
// Top Header
function julia_kaya_top_header_bg_type(){
...
// Sticky Logo
function julia_kaya_sticky_logo_change(){
	$('#customize-control-select_header_logo_type select').change(function(){
...
function julia_kaya_body_bg_settings(){
...
// Most footer bottom 
	$('#customize-control-select_footer_type select').change(function(){
		var default_footer_disable = ["disable_footer_sticky", "bottom_footer_contact_info", "bottom_footer_copyrights_info", "footer_social_icons_text", "social_icon_followus_text","facebook_icon_id","twitter_icon_id","linkedin_icon_id","youtube_icon_id","googleplus_icon_id","dribble_icon_id", "instagram_icon_id","rss_icon_id","footer_color_section_text","footer_bg_color","footer_border_top_color","footer_text_color","footer_text_link_color","footer_text_link_hover","footer_text_font_size","footer_text_letter_space","footer_text_font_weight","footer_text_font_style", "digg_icon_id"]; // IDs for show / hide content
			$('#customize-control-footer_page_id').hide().addClass('customize-control-options-remove');
			$.each(default_footer_disable, function(index, value){
				$('#customize-control-' + value ).hide().addClass('customize-control-options-remove');
			});
			var footer_display_type = $('#customize-control-select_footer_type select option:selected').val();
			switch( footer_display_type ){
				case 'page_type_footer':
					$('#customize-control-footer_page_id').show().removeClass('customize-control-options-remove');
					break;
				case 'default_footer':
					$.each(default_footer_disable, function(index, value){
						$('#customize-control-' + value ).show().removeClass('customize-control-options-remove');
					});
					break;	
			} 
	}).change();
// Content Popup Box
$('#customize-control-enable_content_popup_box input').change(function(){
	$('#customize-control-content_wrng_popup_text').hide().addClass('customize-control-options-remove');
	$('#customize-control-contnet_warning_bg_color').hide().addClass('customize-control-options-remove');
	$('#customize-control-contnet_warning_btn_color').hide().addClass('customize-control-options-remove');
	$('#customize-control-content_wrng_button_text').hide().addClass('customize-control-options-remove');
	$('#customize-control-contnet_warning_btn_bg_color').hide().addClass('customize-control-options-remove');
	$('#customize-control-contnet_warning_color').hide().addClass('customize-control-options-remove');	
	var enable_popup = $('#customize-control-enable_content_popup_box input').is(':checked');
	if( enable_popup ){
		$('#customize-control-content_wrng_popup_text').show().removeClass('customize-control-options-remove');
		$('#customize-control-contnet_warning_bg_color').show().removeClass('customize-control-options-remove');
		$('#customize-control-contnet_warning_btn_color').show().removeClass('customize-control-options-remove');
		$('#customize-control-content_wrng_button_text').hide().removeClass('customize-control-options-remove');
		$('#customize-control-contnet_warning_color').show().removeClass('customize-control-options-remove');
		$('#customize-control-contnet_warning_btn_bg_color').show().removeClass('customize-control-options-remove');
	}
}).change();
// Shortlist 
$('#customize-control-print_logo_type select').change(function(){
	$('#customize-control-print_logo_img').hide().addClass('customize-control-options-remove');
	$('#customize-control-print_text_logo').hide().addClass('customize-control-options-remove');
	$('#customize-control-print_logo_tagline').hide().addClass('customize-control-options-remove');
	var header_bg_type = $('#customize-control-print_logo_type select option:selected').val();
	switch( header_bg_type ){
		case 'text_logo':			
			$('#customize-control-print_text_logo').show().removeClass('customize-control-options-remove');
			$('#customize-control-print_logo_tagline').show().removeClass('customize-control-options-remove');
			break;
		case 'img_logo':
			$('#customize-control-print_logo_img').show().removeClass('customize-control-options-remove');
			break;
		case 'default':
			break;		
	}
...
//hiding shortlist
$('#customize-control-disable_shortlist_settings input').change(function(){
	$('#customize-control-enable_shortlist_settings_login_users').show().removeClass('customize-control-options-remove');
	$('#customize-control-pf_short_list_page_name').show().removeClass('customize-control-options-remove');
	$('#customize-control-pf_short_list_page_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-pf_short_list_icon_name').show().removeClass('customize-control-options-remove');
	$('#customize-control-pf_short_list_icons_url').show().removeClass('customize-control-options-remove');
	$('#customize-control-add_short_list_button_colors_title').show().removeClass('customize-control-options-remove');
	$('#customize-control-disable_shortlist_buttons_desc').show().removeClass('customize-control-options-remove');
	$('#customize-control-add_short_list_buttons_bg_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-add_short_list_buttons_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-shortlist_buttons_colors_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-shortlist_clear_all_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-shortlist_print_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-shortlist_pdf_download_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-shortlist_email_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-shortlist_booking_email_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_buttons_bg_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_buttons_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_buttons_hover_bg_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_buttons_hover_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_email_section').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_sender_email_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_sender_name_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_receiver_email_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_message_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_email_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-shortlist_email_success_msg').show().removeClass('customize-control-options-remove');
	$('#customize-control-shortlist_email_error_msg').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_email_form_bg_colors').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_input_fields_border_colors').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_input_fields_colors').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_form_button_bg_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_form_button_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_form_button_hover_bg_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_form_hover_button_color').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_button_text_title').show().removeClass('customize-control-options-remove');
	$('#customize-control-short_list_button_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-remove_short_list_button_text').show().removeClass('customize-control-options-remove');
	$('#customize-control-print_logo_title').show().removeClass('customize-control-options-remove');
	$('#customize-control-print_logo_type').show().removeClass('customize-control-options-remove');
	$('#customize-control-print_logo_img').show().removeClass('customize-control-options-remove');
	$('#customize-control-print_text_logo').show().removeClass('customize-control-options-remove');
	$('#customize-control-print_logo_tagline').show().removeClass('customize-control-options-remove');
	$('#customize-control-print_content_section').show().removeClass('customize-control-options-remove');
	$('#accordion-section-shortlist_booking_section').show().removeClass('customize-control-options-remove');

	var select_search_value = $('#customize-control-disable_shortlist_settings input').is(':checked');
	if( select_search_value ){
		$('#customize-control-enable_shortlist_settings_login_users').hide().addClass('customize-control-options-remove');
		$('#customize-control-pf_short_list_page_name').hide().addClass('customize-control-options-remove');
		$('#customize-control-pf_short_list_page_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-pf_short_list_icon_name').hide().addClass('customize-control-options-remove');
		$('#customize-control-pf_short_list_icons_url').hide().addClass('customize-control-options-remove');
		$('#customize-control-add_short_list_button_colors_title').hide().addClass('customize-control-options-remove');
		$('#customize-control-disable_shortlist_buttons_desc').hide().addClass('customize-control-options-remove');
		$('#customize-control-add_short_list_buttons_bg_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-add_short_list_buttons_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-shortlist_buttons_colors_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-shortlist_clear_all_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-shortlist_print_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-shortlist_pdf_download_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-shortlist_email_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-shortlist_booking_email_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_buttons_bg_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_buttons_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_buttons_hover_bg_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_buttons_hover_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_email_section').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_sender_email_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_sender_name_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_receiver_email_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_message_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_email_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-shortlist_email_success_msg').hide().addClass('customize-control-options-remove');
		$('#customize-control-shortlist_email_error_msg').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_email_form_bg_colors').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_input_fields_border_colors').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_input_fields_colors').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_form_button_bg_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_form_button_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_form_button_hover_bg_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_form_hover_button_color').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_button_text_title').hide().addClass('customize-control-options-remove');
		$('#customize-control-short_list_button_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-remove_short_list_button_text').hide().addClass('customize-control-options-remove');
		$('#customize-control-print_logo_title').hide().addClass('customize-control-options-remove');
		$('#customize-control-print_logo_type').hide().addClass('customize-control-options-remove');
		$('#customize-control-print_logo_img').hide().addClass('customize-control-options-remove');
		$('#customize-control-print_text_logo').hide().addClass('customize-control-options-remove');
		$('#customize-control-print_logo_tagline').hide().addClass('customize-control-options-remove');
		$('#customize-control-print_content_section').hide().addClass('customize-control-options-remove');
		$('#accordion-section-shortlist_booking_section').hide().addClass('customize-control-options-remove');
	}else{
